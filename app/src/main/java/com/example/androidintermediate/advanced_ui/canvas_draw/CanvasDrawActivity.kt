package com.example.androidintermediate.advanced_ui.canvas_draw
...
import com.example.androidintermediate.databinding.ActivityCanvasDrawBinding
...
class CanvasDrawActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityCanvasDrawBinding.inflate(layoutInflater)
