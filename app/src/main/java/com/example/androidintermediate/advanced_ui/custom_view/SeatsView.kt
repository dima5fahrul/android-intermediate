...
class SeatsView : View {
    ...
    private val titleSeatPaint = Paint(Paint.FAKE_BOLD_TEXT_FLAG)
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val text = context.getString(R.string.silahkan_pilih_kursi)
        titleSeatPaint.apply { textSize = 50F }
        canvas.drawText(text, (width / 2F) - 197F, 100F, titleSeatPaint)
    }
