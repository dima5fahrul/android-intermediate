...
class ImageBannerWidget : AppWidgetProvider() {
    ...
    companion object {
        private const val TOAST_ACTION = "com.example.androidintermediate.TOAST_ACTION"
        const val EXTRA_ITEM = "com.example.androidintermediate.EXTRA_ITEM"

        // pindahkan fungsi ini ke companion object, karena kita akan memanggilnya dari luar kelas
