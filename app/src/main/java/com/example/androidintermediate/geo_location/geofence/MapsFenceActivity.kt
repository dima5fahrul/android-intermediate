package com.example.androidintermediate.geo_location.geofence
...
import com.example.androidintermediate.databinding.ActivityMapsFenceBinding
...
class MapsFenceActivity : AppCompatActivity(), OnMapReadyCallback {

    private lateinit var mMap: GoogleMap
    private lateinit var binding: ActivityMapsFenceBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityMapsFenceBinding.inflate(layoutInflater)
