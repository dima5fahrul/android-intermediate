...
import com.example.androidintermediate.databinding.ActivityLogin2Binding
    ...
    private fun signIn() {
        ...
        lifecycleScope.launch {
            try {
                ...
                Log.d("LoginActivity", "Error signing in: ${e.message}")
            }
        }
    }
            ...
            is CustomCredential -> {
                if (credential.type == GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL) {
                    try {
                        ...
                        Log.d("LoginActivity", "Error getting Google ID token: ${e.message}")
                    }
                } else {
                ...
                Log.e(TAG, "Unknown credential type: ${credential.javaClass}")
            }
        }
    }
